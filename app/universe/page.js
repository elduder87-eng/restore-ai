...
if (planetMesh.current) planetMesh.current.rotation.y += 0.003;
...
<meshStandardMaterial color="#7cffb0" emissive="#7cffb0" emissiveIntensity={1.2} />
  ...
  <mesh scale={1.15}>
    <sphereGeometry args={[0.55, 64, 64]} />
    <meshBasicMaterial color="#7cffb0" transparent opacity={0.18} />
  </mesh>
...
<color attach="background" args={["#020617"]} />
    ...
    <ScienceSystem radius={7} speed={0.16} startAngle={Math.PI * 1.2} />
