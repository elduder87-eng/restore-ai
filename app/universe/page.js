...
particles[i] = (Math.random() - 0.5) * 500;
}
...
<mesh ref={mesh}>
<sphereGeometry args={[size,64,64]} /><meshStandardMaterial
color={color}
emissive={color}
...
</mesh><Label position={[0,size+0.6,0]}>{label}</Label>
...
</EffectComposer><OrbitControls enablePan enableZoom enableRotate enableDamping dampingFactor={0.05}/></Canvas></div>)
